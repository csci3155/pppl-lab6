...
// Parse the JavaScripty expression in your worksheet using the reference parser
val worksheetJsy = JsyParser.parseFile("src/main/scala/jsy/student/Lab6.worksheet.ts")

// Parse the JavaScripty expression in your worksheet using your parser
//val myWorksheetJsy = yourparser.parseFile("src/main/scala/jsy/student/Lab6.worksheet.ts")
